...
import { fetchDrinkDetails, getIngredientsImageUrl } from "../../services/cocktailService";
import "../../App.css";
...
const DrinkDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchDrinkDetails(idDrink); // Use service function
        setDrink(data);
      } catch (error) {
              ...
              {Array.from({ length: 15 }).map((_, index) => {
                ...
                return (
                  ingredient && (
                    ...
                    >
                      <img
                        src={getIngredientsImageUrl(ingredient)} // Use utility function
                        alt={ingredient}
