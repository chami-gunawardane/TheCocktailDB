    ...
    <div className="bg-gradient-to-r from-black via-red-950 to-black text-white p-4 sm:p-8">
      ...
      <main className="flex flex-col lg:flex-row lg:gap-12 items-center lg:items-start">
        ...
        <div className="relative flex flex-col items-center lg:items-start w-full lg:w-1/3 mb-8 lg:mb-0 ml-4">
          ...
          {/* Add to Cart Button positioned at the bottom of the image */}
          <div className="absolute -bottom-32 left-[350px] transform -translate-x-1/2 mb-4">
            <Button
              text="Add to Cart"
              customClass="bg-white text-black px-6 sm:px-8 py-2 sm:py-3 rounded-lg shadow-md hover:shadow-lg hover:bg-gray-300 font-bold inline-flex items-center gap-2 transition-transform duration-300 hover:scale-105"
              image={<img src={CartIcon} alt="Cart" className="h-4 sm:h-5 w-4 sm:w-5" />}
        ...
        <div className="flex-1 w-full">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm sm:text-lg">Serve: {highlightText(drink.strGlass)}</p>
          </section>
        </div>
      </main>
    </div>
